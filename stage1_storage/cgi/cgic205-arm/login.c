...
void unencode_for_name_pass(char *input)
{
	...
	{
		//printf("<script language='javascript'>document.location = 'http://169.254.200.90:8080/choose.html'</script>"); //自动跳转到这个页面	
		printf("<script language='javascript'>document.location = 'http://192.168.5.9:90/choose.html'</script>"); //自动跳转到这个页面	
	}
	else{
